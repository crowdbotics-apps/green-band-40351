"""
Django settings for green_band_40351 project.
...
ROOT_URLCONF = 'green_band_40351.urls'
...
WSGI_APPLICATION = 'green_band_40351.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "green_band_40351 API",
    "DESCRIPTION": "API documentation for green_band_40351 App",
    "VERSION": "v1",
}
